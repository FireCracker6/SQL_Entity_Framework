            ...
            if (_customerEntity != null)
            {
                ...
                if (!string.IsNullOrEmpty(customer.StreetName) || !string.IsNullOrEmpty(customer.PostalCode) || !string.IsNullOrEmpty(customer.City))
                {
                    ...
                    else
                    {
                        ...
                        addressEntity.StreetName = !string.IsNullOrEmpty(customer.StreetName) ? customer.StreetName : _customerEntity.Address.StreetName;
                        addressEntity.PostalCode = !string.IsNullOrEmpty(customer.PostalCode) ? customer.PostalCode : _customerEntity.Address.PostalCode;
                        addressEntity.City = !string.IsNullOrEmpty(customer.City) ? customer.City : _customerEntity.Address.City;
                                            
                        _context.Add(addressEntity);
                        await _context.SaveChangesAsync();
                        _customerEntity.AddressId = addressEntity.Id;
                    }
